...
export class WalletSelector extends LitElement {
  ...
  render() {
    return html`
        <div id="wallet-selector" class="WalletSelectView ListCustomSelectView form_field" data-walletchosen="true">
            <!-- selected wallet -->
            ...
            <div id="wallet-options" class="options_containerView">
                <div class="options_cellViews_containerView" style="position: relative; left: 0px; top: 0px; width: 100%; height: 100%; z-index: 20; overflow-y: auto; max-height: 174.9px;"></div>
                    ${this.wallets.map((wallet) => {
                        //return html`<provider-card .service=${service} @click=${this.clickHandler}></provider-card>`
                        return html`
                        <div data-walletlabel="1" data-walletoffset="0" data-swatch="00F4CD" data-walletbalance="0.00052545" data-walletid="dd7e2ba0-d80d-11eb-b0fd-5d37c436790f" data-walletpublicaddress="47pasa5moXNCSyvvip6sY39VFGYymMhVEXpcaZSaP3hAVNbVXpGu5MVZn9ePeotMRFiJuLq2pB6B3Hm7uWYanyJe1yeSbm9" class="hoverable-cell utility optionCell" style="word-break: break-all; height: 66px; position: relative; left: 0px; top: 0px; box-sizing: border-box; width: 100%;">                    
